...
func TestClone_RequestHeaders(t *testing.T) {
	...
	require.NotEqual(t, getLog(t).RequestHeaders, logCopy.RequestHeaders)
...
func TestClone_ResponseHeaders(t *testing.T) {
	...
	require.NotEqual(t, getLog(t), logCopy)
	require.Equal(t, getLog(t), clone)
}
...
func TestClone_Cookies(t *testing.T) {
	...
	newLog := getLog(t)
	require.NotEqual(t, newLog.Cookies[0].Unparsed, logCopy.Cookies[0].Unparsed)
